...
function MyHomepage() {
  return (
    ...
    <div className="mdk-header-layout js-mdk-header-layout" data-domfactory-upgraded="mdk-header-layout">
            ...
            <div id="header" className="mdk-header mdk-header--bg-dark bg-dark js-mdk-header mb-0" data-effects="parallax-background waterfall" data-fixed="" data-condenses="" data-retarget-mouse-scroll="" data-domfactory-upgraded="mdk-header">
                <div className="mdk-header__bg" >
                    <div className="mdk-header__bg-front" 
                    style={{backgroundImage: 'url(https://luma.humatheme.com/public/images/photodune-4161018-group-of-students-m.jpg)'}}>
                    </div>
                <div className="mdk-header__bg-rear"></div></div>
                <div className="mdk-header__content justify-content-center">

                    <div className="navbar navbar-expand navbar-dark-pickled-bluewood will-fade-background mdk-header--fixed mdk-header--shadow bg-transparent" id="default-navbar" data-primary="data-primary">
                </div>
            </div>
                        ...
                        <div className="row card-group-row">
                            ...
                            <div className="col-md-6 col-lg-4 card-group-row__col">
                                ...
                                <div className="card card--elevated posts-card-popular overlay card-group-row__card">
                                    ...
                                    <div className="fullbleed bg-primary"></div>
                                    <div className="posts-card-popular__content">
                                        <div className="card-body d-flex align-items-center">
                                            <div className="avatar-group flex">
                                                <div className="avatar avatar-xs" data-toggle="tooltip" data-placement="top" title="" data-original-title="Janell D.">
                                                    <a href=""><img src="" alt="Avatar" className="avatar-img rounded-circle"/></a>
                                                </div>
                                            </div>
                                            <a className="d-flex align-items-center" href=""><RemoveRedEyeIcon className="material-icons mr-1" /><small>327</small></a>
                                        </div>
                                ...
                                <div className="card card--elevated posts-card-popular overlay card-group-row__card">
                                    ...
                                    <div className="posts-card-popular__content">
                                        <div className="card-body d-flex align-items-center">
                                            ...
                                            <a className="d-flex align-items-center" href=""><RemoveRedEyeIcon className="material-icons mr-1" />r<small>327</small></a>
                                        </div>
                                        <div className="posts-card-popular__title card-body">
                ...
                <div className="page-section">
                    <div className="container page__container">
                        <div className="page-headline text-center">
                            <h2>Feedback</h2>
                            <p className="lead measure-lead mx-auto text-70">What other students turned professionals have to say about us after learning with us and reaching their goals.</p>
                        </div>

                        <div className="position-relative carousel-card p-0 mx-auto">
                            <div className="row d-block js-mdk-carousel" id="carousel-feedback" data-interval="3000" data-domfactory-upgraded="mdk-carousel">
                                <a className="carousel-control-next js-mdk-carousel-control mt-n24pt" href="#carousel-feedback" role="button" data-slide="next" data-domfactory-upgraded="mdk-carousel-control">
                                ...
                                <div className="mdk-carousel__content" >
                                    ...
                                    <div className="col-12 col-md-6 mdk-carousel__item" >
                                        ...
                                        <div className="media ml-12pt">
                                            <div className="media-left mr-12pt">
                                                <a href="student-profile.html" className="avatar avatar-sm">
                                                    <img src="../../public/images/people/110/guy-.jpg" width="40" alt="avatar" className="rounded-circle"/>
                                                    <span className="avatar-title rounded-circle">UK</span>
                                                </a>
                                            </div>
                                            <div className="media-body media-middle">
                                                <a href="student-profile.html" className="card-title">Umberto Kass</a>
