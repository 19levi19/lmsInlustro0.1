    ...
    <div className="home">
      ...
      <div className="homeContainer">
        ...
        <div className="Quizz">
          <Quizz />
          <p>
          The quiz is an integral part of the educational content provided through the LMS. It aims to assess your understanding and knowledge of the course material.
          </p>
        </div>
        <footer>
